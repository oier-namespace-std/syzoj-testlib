/*
 * This is the modified version of testlib which can run on SYZOJ-based system.
 * Namespace Std 202010 MODIFIED VERSION.
*/
...
#ifndef SYZOJ_TESTLIB
#define SYZOJ_TESTLIB 202010L
#endif
...
NORETURN void InStream::quit(TResult result, const char* msg)
{
    ...
    #ifdef SYZOJ_TESTLIB
    /* 
    	The 'failed' verdict message will be implemented in judger.
    ...
    */
    ...
    #ifdef SYZOJ_TESTLIB
        // std::cerr << "Testlib is generating results..." << std::endl;
	    // flush score into stdout.
	    if(result == _ok) std::cout << 100 << std::endl;
	    if(result == _wa) std::cout << 0 << std::endl;
	    if(result == _pe) std::cout << 0 << std::endl;
	    if(result == _dirt) std::cout << 0 << std::endl;
    #endif
...
NORETURN void __testlib_quitp(double points, const char* message)
{
    ...
    #ifdef SYZOJ_TESTLIB
	    // flush score into stdout.
	    std::cout << (int)(points*100) << std::endl;
    #endif
